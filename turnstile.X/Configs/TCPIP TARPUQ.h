 ...
 */
#define MY_DEFAULT_HOST_NAME			"TURNSTILE"
...
#define MY_DEFAULT_IP_ADDR_BYTE4        (73ul)
...
#define MY_DEFAULT_DEVICE_ID            (1ul)

#define MY_DEFAULT_SERVER_IP_ADDR_BYTE1 (192ul)
#define MY_DEFAULT_SERVER_IP_ADDR_BYTE2 (168ul)
#define MY_DEFAULT_SERVER_IP_ADDR_BYTE3 (0ul)
#define MY_DEFAULT_SERVER_IP_ADDR_BYTE4 (100ul)
