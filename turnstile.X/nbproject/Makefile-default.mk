...
SOURCEFILES_QUOTED_IF_SPACED=mcc_generated_files/device_config.c mcc_generated_files/mcc.c mcc_generated_files/pin_manager.c mcc_generated_files/spi1.c mcc_generated_files/tmr0.c mcc_generated_files/interrupt_manager.c mcc_generated_files/ext_int.c mcc_generated_files/tmr1.c "TCPIP Stack/Announce.c" "TCPIP Stack/ARP.c" "TCPIP Stack/AutoIP.c" "TCPIP Stack/DHCP.c" "TCPIP Stack/DNS.c" "TCPIP Stack/ETH97J60.c" "TCPIP Stack/Helpers.c" "TCPIP Stack/ICMP.c" "TCPIP Stack/IP.c" "TCPIP Stack/StackTsk.c" "TCPIP Stack/TCP.c" "TCPIP Stack/Tick.c" "TCPIP Stack/UDP.c" "TCPIP Stack/HTTP2.c" "TCPIP Stack/Hashes.c" "TCPIP Stack/MPFS2.c" "TCPIP Stack/SPIFlash.c" "TCPIP Stack/FTP.c" "TCPIP Stack/TFTPc.c" main.c GenericTCPClient.c GenericTCPServer.c PingDemo.c CustomHTTPApp.c rfid_reader.c sTimer.c RTC.c I2CSW.c turnstile_app.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mcc_generated_files/device_config.p1 ${OBJECTDIR}/mcc_generated_files/mcc.p1 ${OBJECTDIR}/mcc_generated_files/pin_manager.p1 ${OBJECTDIR}/mcc_generated_files/spi1.p1 ${OBJECTDIR}/mcc_generated_files/tmr0.p1 ${OBJECTDIR}/mcc_generated_files/interrupt_manager.p1 ${OBJECTDIR}/mcc_generated_files/ext_int.p1 ${OBJECTDIR}/mcc_generated_files/tmr1.p1 "${OBJECTDIR}/TCPIP Stack/Announce.p1" "${OBJECTDIR}/TCPIP Stack/ARP.p1" "${OBJECTDIR}/TCPIP Stack/AutoIP.p1" "${OBJECTDIR}/TCPIP Stack/DHCP.p1" "${OBJECTDIR}/TCPIP Stack/DNS.p1" "${OBJECTDIR}/TCPIP Stack/ETH97J60.p1" "${OBJECTDIR}/TCPIP Stack/Helpers.p1" "${OBJECTDIR}/TCPIP Stack/ICMP.p1" "${OBJECTDIR}/TCPIP Stack/IP.p1" "${OBJECTDIR}/TCPIP Stack/StackTsk.p1" "${OBJECTDIR}/TCPIP Stack/TCP.p1" "${OBJECTDIR}/TCPIP Stack/Tick.p1" "${OBJECTDIR}/TCPIP Stack/UDP.p1" "${OBJECTDIR}/TCPIP Stack/HTTP2.p1" "${OBJECTDIR}/TCPIP Stack/Hashes.p1" "${OBJECTDIR}/TCPIP Stack/MPFS2.p1" "${OBJECTDIR}/TCPIP Stack/SPIFlash.p1" "${OBJECTDIR}/TCPIP Stack/FTP.p1" "${OBJECTDIR}/TCPIP Stack/TFTPc.p1" ${OBJECTDIR}/main.p1 ${OBJECTDIR}/GenericTCPClient.p1 ${OBJECTDIR}/GenericTCPServer.p1 ${OBJECTDIR}/PingDemo.p1 ${OBJECTDIR}/CustomHTTPApp.p1 ${OBJECTDIR}/rfid_reader.p1 ${OBJECTDIR}/sTimer.p1 ${OBJECTDIR}/RTC.p1 ${OBJECTDIR}/I2CSW.p1 ${OBJECTDIR}/turnstile_app.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/mcc_generated_files/device_config.p1.d ${OBJECTDIR}/mcc_generated_files/mcc.p1.d ${OBJECTDIR}/mcc_generated_files/pin_manager.p1.d ${OBJECTDIR}/mcc_generated_files/spi1.p1.d ${OBJECTDIR}/mcc_generated_files/tmr0.p1.d ${OBJECTDIR}/mcc_generated_files/interrupt_manager.p1.d ${OBJECTDIR}/mcc_generated_files/ext_int.p1.d ${OBJECTDIR}/mcc_generated_files/tmr1.p1.d "${OBJECTDIR}/TCPIP Stack/Announce.p1.d" "${OBJECTDIR}/TCPIP Stack/ARP.p1.d" "${OBJECTDIR}/TCPIP Stack/AutoIP.p1.d" "${OBJECTDIR}/TCPIP Stack/DHCP.p1.d" "${OBJECTDIR}/TCPIP Stack/DNS.p1.d" "${OBJECTDIR}/TCPIP Stack/ETH97J60.p1.d" "${OBJECTDIR}/TCPIP Stack/Helpers.p1.d" "${OBJECTDIR}/TCPIP Stack/ICMP.p1.d" "${OBJECTDIR}/TCPIP Stack/IP.p1.d" "${OBJECTDIR}/TCPIP Stack/StackTsk.p1.d" "${OBJECTDIR}/TCPIP Stack/TCP.p1.d" "${OBJECTDIR}/TCPIP Stack/Tick.p1.d" "${OBJECTDIR}/TCPIP Stack/UDP.p1.d" "${OBJECTDIR}/TCPIP Stack/HTTP2.p1.d" "${OBJECTDIR}/TCPIP Stack/Hashes.p1.d" "${OBJECTDIR}/TCPIP Stack/MPFS2.p1.d" "${OBJECTDIR}/TCPIP Stack/SPIFlash.p1.d" "${OBJECTDIR}/TCPIP Stack/FTP.p1.d" "${OBJECTDIR}/TCPIP Stack/TFTPc.p1.d" ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/GenericTCPClient.p1.d ${OBJECTDIR}/GenericTCPServer.p1.d ${OBJECTDIR}/PingDemo.p1.d ${OBJECTDIR}/CustomHTTPApp.p1.d ${OBJECTDIR}/rfid_reader.p1.d ${OBJECTDIR}/sTimer.p1.d ${OBJECTDIR}/RTC.p1.d ${OBJECTDIR}/I2CSW.p1.d ${OBJECTDIR}/turnstile_app.p1.d
...
${OBJECTDIR}/sTimer.p1: sTimer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/sTimer.p1.d 
	@${RM} ${OBJECTDIR}/sTimer.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -DCFG_INCLUDE_PICDN2_ETH97 -P -N255 -I"Include" -I"." --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/sTimer.p1 sTimer.c 
	@-${MV} ${OBJECTDIR}/sTimer.d ${OBJECTDIR}/sTimer.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/sTimer.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
